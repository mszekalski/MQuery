...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__snake_view_js__ = __webpack_require__(4);
...
class View {
  ...
  updateClasses(coords, className) {
    Object(__WEBPACK_IMPORTED_MODULE_0__lib_main_js__["default"])("li")
      .filter(`${className}`)
      .removeClass(className);
...
class Snake {
  constructor(board) {
    this.direction = "N";
    this.board = board;
    const center = new __WEBPACK_IMPORTED_MODULE_1__coord_js__["a" /* default */](
...
class Apple {
  ...
  replace() {
    this.location = new __WEBPACK_IMPORTED_MODULE_1__coord_js__["a" /* default */](
